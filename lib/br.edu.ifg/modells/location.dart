    ...
    'Content-Type': 'application/json',
        ...
        body: jsonEncode(<String, dynamic>{
          'fields': <String, dynamic>{
            ...
            "nome": <String, dynamic>{"stringValue": this.nome},
